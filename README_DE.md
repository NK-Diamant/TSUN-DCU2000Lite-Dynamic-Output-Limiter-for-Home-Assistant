...
1. **Zeile 1 (Intelligente Hausverbrauch-Bremse & Spitzenfilter):** Holt im 2-Minuten-Intervall den aktuellen Verbrauch. Über eine switch- und trigger-Weiche fließen Werte bis 800W sofort durch. Lastspitzen über 800W (z. B. Kaffeemaschine, Wasserkocher) werden für 2 Minuten blockiert. Kurze Peaks von unter einer Minute werden so vollständig ignoriert, was den Akku schont.
